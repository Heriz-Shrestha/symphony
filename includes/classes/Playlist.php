<?php
	class Playlist {
        ...
        public function getSongIds(){
            $songIds = mysqli_query($this->con,"SELECT songId FROM playlistSongs WHERE playlistId='$this->id' ORDER BY playlistOrder ASC"); //lowest albumOrder is at top of the list
            //var_dump($songIds);
            $array = array();
